...
[![License: Prosperity 3.0](https://img.shields.io/badge/License-Prosperity%203.0-blue)](https://github.com/CoReason-AI/coreason_sandbox/blob/main/LICENSE)
...
-   **Deterministic Execution**: Ensure 100% mathematical accuracy by running Python code instead of simulating it with LLMs.
-   **Strict Isolation**: Code runs in disposable, network-isolated sandboxes that are destroyed immediately after use, preventing RCE vulnerabilities.
-   **Artifact Capture**: Automatically captures filesystem changes (e.g., generated PNG charts, PDFs) and pipes them back to the user.
...
-   **Secure**: Network isolation by default, strict package allowlisting, and resource throttling (CPU/Memory).
